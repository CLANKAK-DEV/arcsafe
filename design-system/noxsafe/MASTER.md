...
> **STATUS: RESEARCH INPUT, NOT THE ACTIVE SYSTEM.** This file records the
> UI/UX Pro Max query output. Its generic gold/purple palette and Inter pairing
> were rejected because they conflict with NoxSafe's established identity and
> the anti-template review. The canonical, implemented system is
> [`../../design.md`](../../design.md), with executable tokens in
> [`../../frontend/tokens.css`](../../frontend/tokens.css).
